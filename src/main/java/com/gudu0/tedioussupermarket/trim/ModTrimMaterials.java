package com.gudu0.tedioussupermarket.trim;
...
public class ModTrimMaterials {
    public static final ResourceKey<TrimMaterial> BISMUTH =
            ResourceKey.create(Registries.TRIM_MATERIAL, ResourceLocation.fromNamespaceAndPath(TediousSupermarket.MOD_ID, "bismuth"));
